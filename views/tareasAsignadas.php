...
$analista  = $_SESSION['nombre'];
$stmt_tsk = $conn->prepare("SELECT * FROM tareas WHERE analista IN ('$analista', 'Sin asignar')");
                        ...
                        <td>
                            <div class="btn-toolbar d-flex flex-row justify-content-center">
                                <div class="btn-group" role="group">
                                    <a class="btn btn-outline-primary btn-sm verTarea" data-task-id="tsk<?php echo $tarea['id_tarea'] ?>" role="button" data-toggle="modal" title="Ver tarea" href="#/" data-target="#verTarea">
                                        <i class="fa fa-eye"></i>
                                    </a>
                                    <?php if ($tarea['estatus'] != 'Finalizada' && $tarea['estatus'] != 'Verificada') { ?>
                                        <a class="btn btn-outline-warning btn-sm estatusBtn" data-task-id="tsk<?php echo $tarea['id_tarea'] ?>" data-task-status="En espera" role="button" title="Poner en espera" href="#/" <?php echo $eventDisable ?>>
                                            <i class="fa fa-hand-paper-o"></i>
                                        </a>
                                        <a class="btn btn-outline-info btn-sm estatusBtn" data-task-id="tsk<?php echo $tarea['id_tarea'] ?>" data-task-status="Procesando" role="button" title="Procesando" href="#/" <?php echo $eventDisable ?>>
                                            <i class="fa fa-gears"></i>
                                        </a>
                                        <a class="btn btn-outline-success btn-sm estatusBtn" data-task-id="tsk<?php echo $tarea['id_tarea'] ?>" data-task-status="Finalizada" role="button" title="Finalizar tarea" href="#/" <?php echo $eventDisable ?>>
