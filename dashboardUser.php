    ...
    <div>
        <div class="container-fluid" style="color: #d7d7d7;">
            <div class="row" style="height: 100vh;">
                <div class="col-xl-12 d-flex flex-row justify-content-between" id="topBar" style="background: #505050;color: rgb(255,255,255);text-align: right;padding-top: 2vh;height: 10%;padding-left: 2vw;padding-right: 4vw;padding-bottom: 2vh;">
                ...
                <div class="col-1 col-sm-1 col-md-1 col-lg-1 col-xl-1 d-flex flex-column align-items-center" id="sidebar" style="background: lightgray;padding-top: 2em;height: 90%;border-width: 2px;border-style: solid;border-top-style: none;border-right-width: 1px;border-right-style: none;border-bottom-style: none;border-left-style: none;">
                    ...
                    <a class="text-muted sidebtn" data-toggle="tooltip" data-bs-tooltip="" data-placement="right" id="ticketsUsuario" href="#/" title="Mis tickets" data-btn="ticketsUsuario"><i class="fa fa-ticket" style="font-size: 3vw"></i></a>
                ...
                <div class="col-11 col-sm-11 col-md-11 col-lg-11 col-xl-11 flex-row justify-content-center align-items-center" id="contenido" style="background: #333333;padding-top: 2em; max-height:90%; overflow-y:scroll" data-page="usuario">
                    <!-- CONTENIDO -->
                </div>
            </div>
        </div>
